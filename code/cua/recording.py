...
class TrajectorySession:
    def __init__(self, output_dir: Path, *, session_id: str = "", goal: str = "", app: str = ""):
        self.output_dir = output_dir
        self.session_id = session_id
        self.goal = goal
        self.app = app
        self._client = CuaDriverClient()
        self._started = False
...
def start_recording(
    ...
    *,
    ...
    sess = TrajectorySession(out, session_id=session_id, goal=goal, app=app)
    sess.start()
    return sess
