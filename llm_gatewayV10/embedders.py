...
PROVIDER 2: OpenAIEmbedder (default fallback) — text-embedding-3-small
with dimensions=768. Requires OPENAI_API_KEY.

PROVIDER 3: GeminiEmbedder — optional fallback when
EMBED_FALLBACK_PROVIDER=gemini. Hits generativelanguage.googleapis.com
gemini-embedding-001 with outputDimensionality=768 so the vector space
matches Ollama's nomic output dimension.
