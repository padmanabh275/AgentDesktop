"""V10 vision smoke: round-trip an image through the gateway.
...
Run from llm_gatewayV10/: uv run python tests/test_vision_smoke.py
"""
import base64
import io
import json
...
GW = os.getenv("LLM_GATEWAY_V10_URL") or os.getenv("LLM_GATEWAY_V9_URL") or "http://localhost:8110"
